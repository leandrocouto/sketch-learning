...
class IteratedBestResponse:
    ...
    def log_results(self, score_br, score_test, force_write=False):
        ...
        if score_br is not None:
            self.log_results_data.append((self.id_log, score_br, score_test, time.time() - self.time_start))
    ...
    def ibr_sa(self, 
        ...
        while True:
            ...
            evaluation_function = EvalDoubleProgramDefeatsStrategy(number_evaluations, target_player)
            ...
            winrate, program = self.search_algorithm.search(operations, 
                                                           ...
                                                           alpha,
                                                           beta,
                                                           time_limit - (time.time() - self.time_start),
            ...
            _, br_wins, _ = matches_runner.play_n_matches(number_evaluations, Rule_of_28_Player_Double_Program(program, 'best_response'), test_player)
