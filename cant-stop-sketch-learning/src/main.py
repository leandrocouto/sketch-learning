...
from evaluation import EvalStateBasedImitationGlennAgent, EvalStateBasedImitationRandomAgent, EvalActionBasedImitationAgent
...
def main():
    ...
    parser.add_argument('-search', action='store', dest='search_algorithm', 
                        ...
                        help='Search Algorithm (SimulatedAnnealing, BottomUpSearch, UCT, SketchSimulatedAnnealing, SketchUCT)')
    ...
    parser.add_argument('-e', action='store', dest='eval_function', 
                        ...
                        help='Evaluation function (EvalDoubleProgramDefeatsStrategy, EvalStateBasedImitationAgent, EvalStateBasedImitationGlennAgent, EvalStateBasedImitationRandomAgent, EvalActionBasedImitationAgent, EvalActionBasedImitationGlennAgent, EvalActionBasedImitationRandomAgent)')
    
    parser.add_argument('-e_2', action='store', dest='eval_function_2', 
                        default='EvalDoubleProgramDefeatsStrategy', 
                        help='Evaluation function for the BR-search (EvalDoubleProgramDefeatsStrategy, EvalStateBasedImitationAgent, EvalStateBasedImitationGlennAgent, EvalStateBasedImitationRandomAgent, EvalActionBasedImitationAgent, EvalActionBasedImitationGlennAgent, EvalActionBasedImitationRandomAgent)')
    ...
    parser.add_argument('-time_2', action='store', dest='time_limit_2', default=120,
                        help='Time limit in seconds')
    
    parser.add_argument('-temperature', action='store', dest='initial_temperature', default=100,
                        help='SA\'s initial temperature')
    
    parser.add_argument('-confidence_triage', action='store', dest='confidence_triage', default=0.9,
    ...
    if parameters.eval_function == 'EvalDoubleProgramDefeatsStrategy':
        eval_function = globals()[parameters.eval_function](number_games, confidence_triage=float(parameters.confidence_triage))
    else:
    ...
    if parameters.run_ibr:
        ...
        if isinstance(algorithm, SimulatedAnnealing) or isinstance(algorithm, SketchSimulatedAnnealing):
