...
import CFG_UCT.If_B_then_S;
import rts.GameState;
import rts.units.Unit;

public class If_B_then_S extends Node {
	...
	public If_B_then_S(Node b, Node s) {
		n_true = 0;
		n_false = 0;
		this.children.add(b);
		this.children.add(s);
	...
	public String translate() {
		return "if("+this.children.get(0).translate()+") then {"+this.children.get(1).translate()+"}";
	}
	...
	public Node Clone(Factory f) {
		return f.build_If_B_then_S(this.children.get(0).Clone(f),this.children.get(1).Clone(f));
	}
