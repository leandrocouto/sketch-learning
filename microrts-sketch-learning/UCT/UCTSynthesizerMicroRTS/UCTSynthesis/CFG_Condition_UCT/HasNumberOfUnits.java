...
public class HasNumberOfUnits extends Node {
	...
	public HasNumberOfUnits(Node type,Node n) {
		super();
	...
	public String translate() {
		// TODO Auto-generated method stub
		return "HasNumberOfUnits("+this.children.get(0).getSValue()+","+this.children.get(1).getSValue()+")";
	}
	...
	public Node Clone(Factory f) {
		// TODO Auto-generated method stub
		return f.build_HasNumberOfUnits(this.children.get(0).Clone(f),this.children.get(1).Clone(f));
	}
