...
public class HaveQtdUnitsAttacking extends Node {
	...
	public HaveQtdUnitsAttacking(Node n) {
		this.children.add(n);
		this.NTotalChildren = 1;
		this.NUsedChildren = 1;
	}
	...
	public String translate() {
		// TODO Auto-generated method stub
		return "HaveQtdUnitsAttacking("+this.children.get(0).getSValue()+")";
	}
	...
	public Node Clone(Factory f) {
		// TODO Auto-generated method stub
		return f.build_HaveQtdUnitsAttacking(this.children.get(0).Clone(f));
	}
